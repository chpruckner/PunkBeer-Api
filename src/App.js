      ...
      {console.log("asdfa", typeof(props.id))}
        <div className="card mb-3 p-3">
          <div className="row">
            ...
            <div className="col-md-8 d-flex flex-column align-itmes-stretch">
              <div className="card-body text-left pt-0">
    <p className="card-text">{props.ids.hasOwnProperty(id) ? <FaHeart onClick={() => props.setFav(id)} /> : <FaRegHeart onClick={() => props.setFav(id)} /> }</p>
        ...
        <div>
          ...
          <Switch>
            <Route path="/favourites">
              {this.state.fav_beers && <ListContainer beers1={this.state.fav_beers} setFav={this.setFav} ids={this.state.fav_ids} />}
            </Route>
            <Route path="/">
              <div className="App">
